...
<div className="text-center">
  <Image
    alt="A code review issue flowing into four automated guardrail lanes"
    src="/static/images/say-it-twice-hero.png"
    width={800}
    height={400}
  />
</div>
...
I reviewed a pull request (PR) a few weeks ago in a Playwright repository and left a comment I had left before. Same reviewer (me), same repository, different author: _"Please don't use `waitForTimeout`. Use a web-first assertion instead."_
...
| 02   | **Continuous integration (CI) check** | ~2 minutes after push | The author fixes it, not you |
...
One important caveat before the lanes: triage a _single, specific issue_, not a category. "Tests are bad" isn't triageable. "Tests assert on Cascading Style Sheets (CSS) class names instead of user-visible behavior" is.
